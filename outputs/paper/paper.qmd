...
Taylor swift (@fig-taylor).

```{r}
#| label: tbl-bills
#| tbl-cap: taylor swift
#| echo: false

talyor_swift <- readRDS(here::here("inputs/talyorswift.rds"))
...
Also bills and their average (@fig-taylor). (You can change the height and width, but don't worry about doing that until you have finished every other aspect of the paper - Quarto will try to make it look nice and the defaults usually work.)
